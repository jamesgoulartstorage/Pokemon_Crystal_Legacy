...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move COMET_PUNCH, EFFECT_MULTI_HIT, 25, FIGHTING, 100, 25, 0
	move MEGA_PUNCH, EFFECT_FLINCH_HIT, 120, FIGHTING, 85, 10, 30
	move PAY_DAY, EFFECT_PAY_DAY, 60, DARK, 100, 20, 0
	...
	move GUILLOTINE, EFFECT_CONFUSE_HIT, 120, GHOST, 85, 10, 30
	move RAZOR_WIND, EFFECT_PRIORITY_HIT, 60, FLYING, 95, 15, 0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2, 0, STEEL, 100, 30, 0
	move CUT, EFFECT_PRIORITY_HIT, 60, BUG, 95, 30, 0
	...
	move BIND, EFFECT_TRAP_TARGET, 15, DARK, 85, 20, 0
	move SLAM, EFFECT_NORMAL_HIT, 80, NORMAL, 100, 20, 0
	move VINE_WHIP, EFFECT_DOUBLE_HIT, 45, GRASS, 100, 25, 0
	...
	move SAND_ATTACK, EFFECT_ACCURACY_DOWN, 40, GROUND, 100, 15, 0
	move HEADBUTT, EFFECT_FLINCH_HIT, 70, NORMAL, 100, 15, 30
	move HORN_ATTACK, EFFECT_NORMAL_HIT, 65, NORMAL, 100, 25, 0
	move FURY_ATTACK, EFFECT_MULTI_HIT, 20, STEEL, 100, 20, 0
	move HORN_DRILL, EFFECT_FLINCH_HIT, 120, STEEL, 85, 10, 30
	...
	move TAKE_DOWN, EFFECT_FLINCH_HIT, 95, DARK, 100, 20, 10
	...
	move POISON_STING, EFFECT_PRIORITY_HIT, 60, POISON, 100, 20, 0
	...
	move BITE, EFFECT_PRIORITY_HIT, 60, DARK, 100, 25, 0
	...
	move SONICBOOM, EFFECT_STATIC_DAMAGE, 40, NORMAL, 100, 20, 0
	move DISABLE, EFFECT_DISABLE, 0, PSYCHIC_TYPE, 75, 20, 0
	...
	move HYDRO_PUMP, EFFECT_CONFUSE_HIT, 120, WATER, 85, 10, 30
	...
	move PSYBEAM, EFFECT_PRIORITY_HIT, 60, PSYCHIC_TYPE, 100, 20, 0
	move BUBBLEBEAM, EFFECT_SPEED_DOWN_HIT, 75, WATER, 100, 20, 10
	move AURORA_BEAM, EFFECT_SPEED_DOWN_HIT, 75, ICE, 100, 20, 10
	...
	move STRENGTH, EFFECT_NORMAL_HIT, 95, ROCK, 100, 15, 0
	...
	move RAZOR_LEAF, EFFECT_PRIORITY_HIT, 60, GRASS, 95, 25, 0
	...
	move THUNDER_WAVE, EFFECT_PARALYZE, 20, ELECTRIC, 100, 20, 0
	move THUNDER, EFFECT_THUNDER, 120, ELECTRIC, 85, 10, 30
	move ROCK_THROW, EFFECT_PRIORITY_HIT, 60, ROCK, 95, 25, 0
	move EARTHQUAKE, EFFECT_CONFUSE_HIT, 100, GROUND, 100, 10, 10
	move FISSURE, EFFECT_FLINCH_HIT, 120, GROUND, 85, 10, 30
	move DIG, EFFECT_FLY, 95, GROUND, 100, 20, 0
	...
	move MEDITATE, EFFECT_ATTACK_UP, 0, FIGHTING, 100, 40, 0
	...
	move MINIMIZE, EFFECT_EVASION_UP, 0, PSYCHIC_TYPE, 100, 20, 0
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK, 120, FIGHTING, 95, 20, 0
	move GLARE, EFFECT_PARALYZE, 0, DARK, 90, 30, 0
	move DREAM_EATER, EFFECT_DREAM_EATER, 150, PSYCHIC_TYPE, 100, 15, 0
	move POISON_GAS, EFFECT_POISON, 20, POISON, 85, 40, 0
	move BARRAGE, EFFECT_MULTI_HIT, 20, ROCK, 100, 20, 0
	move LEECH_LIFE, EFFECT_LEECH_HIT, 75, BUG, 100, 25, 0
	move LOVELY_KISS, EFFECT_SLEEP, 0, NORMAL, 75, 10, 0
	move SKY_ATTACK, EFFECT_FLINCH_HIT, 120, FLYING, 85, 10, 30
	move TRANSFORM, EFFECT_TRANSFORM, 0, PSYCHIC_TYPE, 100, 10, 0
	...
	move FLASH, EFFECT_PRIORITY_HIT, 60, GHOST, 100, 20, 0
	move PSYWAVE, EFFECT_CONFUSE_HIT, 75, PSYCHIC_TYPE, 95, 15, 30
	move SPLASH, EFFECT_SPLASH, 0, WATER, 100, 40, 0
	move ACID_ARMOR, EFFECT_DEFENSE_UP_2, 0, POISON, 100, 40, 0
	move CRABHAMMER, EFFECT_NORMAL_HIT, 110, STEEL, 100, 10, 0
	move EXPLOSION, EFFECT_SELFDESTRUCT, 250, NORMAL, 100, 5, 0
	move FURY_SWIPES, EFFECT_MULTI_HIT, 20, NORMAL, 100, 20, 0
	move BONEMERANG, EFFECT_DOUBLE_HIT, 50, DARK, 90, 20, 0
	move REST, EFFECT_HEAL, 0, NORMAL, 100, 5, 0
	move ROCK_SLIDE, EFFECT_FLINCH_HIT, 120, ROCK, 95, 15, 30
	...
	move TRI_ATTACK, EFFECT_TRI_ATTACK, 85, DRAGON, 100, 15, 20
	...
	move SKETCH, EFFECT_SKETCH, 0, GHOST, 100, 1, 0
	...
	move FLAME_WHEEL, EFFECT_PRIORITY_HIT, 60, FIRE, 100, 25, 10
	...
	move AEROBLAST, EFFECT_FLINCH_HIT, 120, FLYING, 95, 10, 30
	...
	move PROTECT, EFFECT_PROTECT, 0, FIGHTING, 100, 10, 0
	move MACH_PUNCH, EFFECT_PRIORITY_HIT, 50, FIGHTING, 100, 30, 0
	move SCARY_FACE, EFFECT_SPEED_DOWN_2, 0, DARK, 90, 10, 0
	move FAINT_ATTACK, EFFECT_ALWAYS_HIT, 75, GHOST, 100, 20, 0
	move SWEET_KISS, EFFECT_CONFUSE, 0, NORMAL, 75, 10, 0
	move BELLY_DRUM, EFFECT_BELLY_DRUM, 0, FIGHTING, 100, 10, 0
	move SLUDGE_BOMB, EFFECT_POISON_HIT, 120, POISON, 85, 10, 30
	move MUD_SLAP, EFFECT_PRIORITY_HIT, 60, GROUND, 100, 15, 100
	move OCTAZOOKA, EFFECT_ACCURACY_DOWN_HIT, 65, WATER, 100, 15, 50
	move SPIKES, EFFECT_SPIKES, 0, ROCK, 100, 20, 0
	move ZAP_CANNON, EFFECT_THUNDER, 100, ELECTRIC, 50, 15, 100
	...
	move ICY_WIND, EFFECT_PRIORITY_HIT, 60, ICE, 100, 20, 100
	move DETECT, EFFECT_PROTECT, 0, FIGHTING, 100, 5, 0
	move BONE_RUSH, EFFECT_MULTI_HIT, 25, DARK, 100, 20, 0
	move LOCK_ON, EFFECT_LOCK_ON, 0, FIGHTING, 100, 5, 0
	...
	move SPARK, EFFECT_PRIORITY_HIT, 60, ELECTRIC, 100, 20, 30
	...
	move PRESENT, EFFECT_PRESENT, 1, GHOST, 90, 15, 0
	...
	move SACRED_FIRE, EFFECT_SACRED_FIRE, 120, FIRE, 95, 10, 50
	move MAGNITUDE, EFFECT_MAGNITUDE, 1, GROUND, 100, 30, 0
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT, 100, FIGHTING, 50, 10, 100
	move MEGAHORN, EFFECT_FLINCH_HIT, 120, BUG, 85, 5, 30
	move DRAGONBREATH, EFFECT_PARALYZE_HIT, 95, DRAGON, 100, 20, 30
	move BATON_PASS, EFFECT_BATON_PASS, 0, NORMAL, 100, 40, 0
	move ENCORE, EFFECT_ENCORE, 0, PSYCHIC_TYPE, 100, 5, 0
	...
	move METAL_CLAW, EFFECT_PRIORITY_HIT, 60, STEEL, 100, 25, 10
	move VITAL_THROW, EFFECT_ALWAYS_HIT, 75, FIGHTING, 100, 10, 0
	...
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER, 1, PSYCHIC_TYPE, 100, 15, 0
	move CROSS_CHOP, EFFECT_DEFENSE_DOWN_HIT, 100, FIGHTING, 90, 10, 20
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT, 75, ROCK, 100, 10, 10
	move SHADOW_BALL, EFFECT_SP_DEF_DOWN_HIT, 90, GHOST, 100, 15, 20
	move FUTURE_SIGHT, EFFECT_CONFUSE_HIT, 120, PSYCHIC_TYPE, 85, 10, 30
	move ROCK_SMASH, EFFECT_PRIORITY_HIT, 60, FIGHTING, 100, 15, 20
	move WHIRLPOOL, EFFECT_TRAP_TARGET, 15, WATER, 70, 15, 0
	move BEAT_UP, EFFECT_DEFENSE_DOWN_HIT, 95, DARK, 100, 15, 30
